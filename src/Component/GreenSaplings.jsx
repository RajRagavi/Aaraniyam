...
import GreenSapling from "../data/greensapling.json"; // Store product details in JSON
    ...
    <div className="w-full mt-24"> {/* Push content below the navbar */}
      ...
      <div className="w-full bg-[rgb(109,140,84)] text-white  flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 flex-shrink-0">
          <img
            src="/img/tree/Tree_Saplings.jpg"
            alt="Bio Fertilizers"
        ...
        <div className="w-full md:w-1/2 px-12 ">
          <p
            className="text-base sm:text-m ">Tree Saplings</p>
          ...
          <div className='flex items-center gap-7 mt-6'>
            ...
            <div>
              <h2 className=' font-inter md:text-3xl text-xl font-bold'>Economic & Social Benefits</h2>
              <p className='text-white md:w-[400px] text-justify'>Tree planting supports the timber, fruit, and paper industries, creating jobs and boosting economies.</p>
            </div>
          </div>
          <div className='flex items-center gap-7 mt-6'>
            <div className='rounded-full bg-brandGreen h-12 w-12 flex justify-center items-center'>
            ...
            <div>
              <h2 className=' font-inter md:text-3xl text-xl font-bold'>Environmental Protection</h2>
              <p className='text-white md:w-[400px] text-justify'> 
              Trees absorb carbon dioxide, release oxygen, and help combat climate change. They also prevent soil erosion and improve air quality.</p>
            </div>
          </div>
